...
% dataTable = load('/Users/juananso/Starr Lab Dropbox/RC+S Patient Un-Synced Data/RCS09 Un-Synced Data/SummitData/SummitContinuousBilateralStreaming/RCS09L/output_data_around_med_times_table.mat')
dataTable = load('/Users/juananso/Starr Lab Dropbox/RC+S Patient Un-Synced Data/RCS09 Un-Synced Data/SummitData/SummitContinuousBilateralStreaming/RCS09L/db_event_medTime_tb5_ta60.mat');
...
hold on; plot([medTime medTime],[min(signal.key0) max(signal.key0)],'r')
legend('key0','t med time')
