function plot_compare_montage_data_from_saved_montage_files(dirname,targetsr)

% you need to run this function first:
% open_and_save_montage_data_in_sessions_directory

%input arguments
% targetsr = '500Hz' or '1000Hz'  (string)
...
%% Color for comparing two states
if partAllOrPart == 2
    color = ['r','b'];
end

%% from target sampling rate string to sampling rate number
if strcmp(targetsr,'500Hz')
    sr = 500;
elseif strcmp(targetsr,'1000Hz')
    sr = 1000;
end
